    ...
    <table id="table" class="display dataTable" style="width:100%">
        <thead>
            <tr>
                ...
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"><fmt:message key="user" bundle="${msg}"/></th>
        ...
        <tbody>
            <c:forEach var="report" items="${sessionScope.reports}">
                <tr>
                    ...
                    <td><a href="controller?command=adminReportDetails&id=${report.id}"><fmt:message key="details" bundle="${msg}"/></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
